...
mongoDB=pymongo.MongoClient('mongodb+srv://dbadmin:gk0VjKmKrs7Q9I6Z@cluster0.bgzcbr7.mongodb.net/?retryWrites=true&w=majority')
db=mongoDB['SalesPrediction']
account=db.account

app=Flask(__name__)
app.secret_key=b'\x10Km\xc3qF\x1c\x9f\xff\tq\x18b\x96a\x8dPT\xfe:\x99\x14\x99\xaa'
CORS(app)
